    ...
    >
      ...
      <AnimatePresence>
        {showNotifBanner && permission === 'default' && (
          ...
          >
            ...
            <button onClick={() => { requestPermission(); setShowNotifBanner(false); }}
              className="text-[11px] font-bold bg-white text-primary rounded-xl px-3 py-1.5 shrink-0 active:scale-95 transition-transform">
              Allow
            </button>
            <button onClick={() => setShowNotifBanner(false)} className="text-white/60 text-xs">✕</button>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <div className="sticky top-0 z-30 bg-background border-b border-border">
        <div className="flex items-center justify-between px-4 pt-4 pb-2">
          <div className="flex items-center gap-2.5">
            <img
              src="https://media.base44.com/images/public/6a13f955573598b80a82a5b2/487d60ee3_ChatGPTImageMay27202601_03_13PM.png"
              alt="Ballia Saathi"
      ...
      <div>
        ...
        <div className="mx-4 mt-4 bg-gradient-to-r from-primary/10 to-accent/10 border border-primary/20 rounded-2xl p-4">
          ...
          <p className="text-muted-foreground text-xs mt-1">Fresh items delivered to your doorstep — ताज़ा सामान, घर पर</p>
        ...
        <ProductSection title="🛒 All Products" products={products.slice(0, 12)} link="/search" userEmail={userEmail} />

        {/* Get everything in 20 minutes banner */}
        <div className="mx-4 mt-6 mb-2 rounded-3xl overflow-hidden relative" style={{ background: 'linear-gradient(135deg, #7c3aed 0%, #a855f7 60%, #ec4899 100%)' }}>
          <div className="p-5 relative z-10">
            ...
            <p className="text-white/70 text-xs mt-2">Fresh groceries delivered to your door</p>
          ...
          <div className="absolute right-10 bottom-4 w-14 h-14 rounded-full bg-white/10" />
